...
/** The Tapjoy Connect Main class. This class provides all publicly available methods for developers to integrate Tapjoy into their
 * applications. */
@NativeClass
public class Tapjoy extends NSObject {
	...
	@Method(selector = "requestTapjoyConnect:secretKey:options:")
	public static native void requestConnect (String appID, String secredKey, NSDictionary<?, ?> options);
...
// @property (nonatomic, strong) TJCLog *log;
	...
	// /**
// * Informs the Tapjoy server that the specified Pay-Per-Action was completed. Should be called whenever a user completes an
// in-game action.
// *
...
//
// /**
// * This method will indicate whether to refresh the Ad periodically. When this method returns YES, Ads are automatically
...
//
// /**
// * The Tapjoy Display Ad UIView returned by this method should be added to the current superview after an Ad has been
// successfully loaded.
// *
...
// *
// * Places the Full Screen Ad UIView on the top of the view stack and animates it into view if an animation transition effect is
// set.
// *
// * @warning This method is deprecated.
...
// *
// * @warning This method is deprecated.
// * @param delayCount The number of times that the app must run (since initial app install) before a full screen ad can be
// displayed.
// * @return n/a
// */
...
// * @return n/a
// */
// + (void)showOffersWithCurrencyID:(NSString*)currencyID withViewController:(UIViewController*)vController
// withCurrencySelector:(BOOL)isSelectorVisible;
//
// @end
//
//
