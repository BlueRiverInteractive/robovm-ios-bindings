 ...
 * 
 * The preferred way of modifying or retrieving channel subscriptions is to use the PFInstallation class, instead of the class
 * methods in PFPush.
 * 
 * This class is currently for iOS only. Parse does not handle Push Notifications to Parse applications running on OS X. Push
 * Notifications can be sent from OS X applications via Cloud Code or the REST API to push-enabled devices (e.g. iOS or Android). */
@NativeClass
public class PFPush extends NSObject {
...
// PARSE_DEPRECATED("Please use a PFInstallation.query with a constraint on deviceType.");
//
// /*!
// Deprecated. Please use a PFInstallation.query with a constraint on deviceType.
// */
...
// error:(NSError *)error. error will be nil on success and set if there was an error. [result boolValue] will tell you whether
...
//
// /*!
// Asynchronously send a push message with arbitrary data to a channel. See the guide for information about the dictionary
// structure.
// @param channel The channel to send to. The channel name must start with
// a letter and contain only letters, numbers, dashes, and underscores.
// @param data The data to send.
...
//
// /*!
// Asynchronously sends a push message with arbitrary data to a channel and calls the given block. See the guide for information
// about the dictionary structure.
// @param channel The channel to send to. The channel name must start with
// a letter and contain only letters, numbers, dashes, and underscores.
// @param data The data to send.
// @param block The block to execute. The block should have the following argument signature: (BOOL succeeded, NSError *error)
...
//
// /*!
// Asynchronously send a push message with arbitrary data to a query. See the guide for information about the dictionary
// structure.
// @param query The query to send to. The query must be a PFInstallation query
// created with [PFInstallation query].
// @param data The data to send.
...
//
// /*!
// Asynchronously sends a push message with arbitrary data to a query and calls the given block. See the guide for information
// about the dictionary structure.
// @param query The query to send to. The query must be a PFInstallation query
// created with [PFInstallation query].
// @param data The data to send.
...
//
    /*
     * A default handler for push notifications while the app is active to mimic the behavior of iOS push notifications while the
     * app is backgrounded or not running. Call this from didReceiveRemoteNotification.
     * 
...
//
// /*!
// Store the device token locally for push notifications. Usually called from you main app delegate's
// didRegisterForRemoteNotificationsWithDeviceToken.
// @param deviceToken Either as an NSData straight from didRegisterForRemoteNotificationsWithDeviceToken or as an NSString if you
// converted it yourself.
// */
...
// @param target The object to call selector on.
// @param selector The selector to call. It should have the following signature: (void)callbackWithResult:(NSSet *)result
// error:(NSError *)error. error will be nil on success and set if there was an error.
// @result Returns an NSSet containing all the channel names this device is subscribed to.
// */
