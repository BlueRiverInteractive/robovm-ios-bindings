...
/** A Parse Framework Object that is a local representation of data persisted to the Parse cloud. This is the main class that is
 * used to interact with objects in your app. */
@NativeClass
...
// @param className A class name can be any alphanumeric string that begins with a letter. It represents an object in your app,
// like a User of a Document.
...
// @param newClassName A class name can be any alphanumeric string that begins with a letter. It represents an object in your app,
// like a User or a Document.
// @result Returns the object that is instantiated with the given class name.
// */
...
// - (NSArray *)allKeys;
    ...
    private native void put (NSObject value, String key);
...
//
    ...
    public native void saveInBackground (@Block VoidBlock2<Boolean, NSError> block);
...
// @param objects The array of objects to save.
// @param target The object to call selector on.
// @param selector The selector to call. It should have the following signature: (void)callbackWithError:(NSError *)error. error
// will be nil on success and set if there was an error.
// */
// + (void)saveAllInBackground:(NSArray *)objects
// target:(id)target
...
// @param selector The selector to call. It should have the following signature: (void)callbackWithResult:(PFObject
// *)refreshedObject error:(NSError *)error. error will be nil on success and set if there was an error. refreshedObject will be
// the PFObject with the refreshed data.
// */
...
// @param target The target on which the selector will be called.
// @param selector The selector to call. It should have the following signature: (void)callbackWithResult:(PFObject
// *)fetchedObject error:(NSError *)error. error will be nil on success and set if there was an error.
// */
...
// @param objects The list of objects to fetch.
// @param target The target on which the selector will be called.
// @param selector The selector to call. It should have the following signature: (void)callbackWithResult:(NSArray
// *)fetchedObjects error:(NSError *)error. error will be nil on success and set if there was an error. fetchedObjects will the
// array of PFObjects that were fetched.
// */
// + (void)fetchAllInBackground:(NSArray *)objects
// target:(id)target
// selector:(SEL)selector;
