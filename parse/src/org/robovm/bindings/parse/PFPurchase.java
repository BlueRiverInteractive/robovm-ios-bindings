...
// @param completion the completion block.
// */
// + (void)downloadAssetForTransaction:(SKPaymentTransaction *)transaction completion:(void(^)(NSString *filePath, NSError
// *error))completion;
//
// /*!
// Asynchronously download the purchased asset, which is stored on Parse's server.
...
// */
// + (void)downloadAssetForTransaction:(SKPaymentTransaction *)transaction completion:(void(^)(NSString *filePath, NSError
// *error))completion progress:(PFProgressBlock)progress;
//
// /*!
