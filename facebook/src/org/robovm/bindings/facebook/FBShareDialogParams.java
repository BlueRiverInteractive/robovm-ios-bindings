...
public class FBShareDialogParams extends FBDialogsParams {
	...
	/*
	 * ! @abstract The link to a thumbnail to associate with the post. Is only used if the link is non-nil. Only "http" or "https" schemes are
	 * supported.
	 */
	...
	/*
	 * ! @abstract An array of NSStrings or FBGraphUsers to tag in the post. If using NSStrings, the values must represent the IDs of the users to
	 * tag.
	 */
	...
	/*
	 * ! @abstract An NSString or FBGraphPlace to tag in the status update. If NSString, the value must be the ID of the place to tag.
	 */
	...
	/*
	 * ! @abstract If YES, treats any data failures (e.g. failures when getting data for IDs passed through "friends" or "place") as a fatal error,
	 * and will not continue with the status update.
	 */
