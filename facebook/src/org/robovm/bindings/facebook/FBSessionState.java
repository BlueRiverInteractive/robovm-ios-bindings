...
public enum FBSessionState implements ValuedEnum {
	...
	Created(0),
	/*
	 * ! One of two initial session states indicating that a cached token was loaded; when a session is in this state, a call to open* will result in
	 * an open session, without UX or app-switching
	 */
