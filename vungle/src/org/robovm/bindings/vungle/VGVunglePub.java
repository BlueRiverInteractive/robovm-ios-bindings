...
public class VGVunglePub extends NSObject {
	...
	@Bridge
	private native static void objc_playModalAd(ObjCClass __self__, Selector __cmd__, UIViewController controller, boolean animated, boolean showClose);
	...
	@Bridge
	private native static void objc_playIncentivizedAd(ObjCClass __self__, Selector __cmd__, UIViewController controller, boolean animated,
			boolean showClose, NSString userTag);

	public static void setAlertBoxConfig(String title, String body, String leftButtonTitle, String rightButtonTitle) {
		objc_setAlertBoxConfig(objCClass, setAlertBoxConfig, new NSString(title), new NSString(body), new NSString(leftButtonTitle), new NSString(
				rightButtonTitle));
	}

	private static final Selector setAlertBoxConfig = Selector.register("alertBoxWithTitle:Body:leftButtonTitle:rightButtonTitle:");

	@Bridge
	private native static void objc_setAlertBoxConfig(ObjCClass __self__, Selector __cmd__, NSString title, NSString body, NSString leftButtonTitle,
