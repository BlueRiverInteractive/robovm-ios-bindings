...
public class GSFullscreenAd extends GSAd {
	...
	static {
		ObjCRuntime.bind(GSFullscreenAd.class);
	}
	...
	@Bridge
	private native static final GSFullscreenAd objc_initWithDelegate(GSFullscreenAd __self__, Selector __cmd__, GSAdDelegate a_delegate);
	...
	@Bridge
	private native static final GSFullscreenAd objc_initWithDelegate(GSFullscreenAd __self__, Selector __cmd__, GSAdDelegate a_delegate, NSString a_GUID);
	...
	@Bridge
	private native static boolean objc_displayFromViewController(GSFullscreenAd __self__, Selector __cmd__, UIViewController a_viewController);
