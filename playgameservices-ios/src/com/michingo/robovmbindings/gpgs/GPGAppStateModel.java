...
public class GPGAppStateModel extends NSObject{
    ...
    @Bridge private native static void objc_setStateData(GPGAppStateModel __self__, Selector __cmd__, NSData state, NSNumber key);
    ...
    @Bridge private native static NSData objc_stateDataForKey(GPGAppStateModel __self__, Selector __cmd__, NSNumber key);
	public NSData stateDataForKey(int key){
    	return objc_stateDataForKey(this, stateDataForKey$, NSNumber.valueOf(key));
    }
	
	//- (void)listStatesWithCompletionHandler:(GPGAppStateListHandler)completionHandler conflictHandler:(GPGAppStateConflictHandler)conflictHandler;
	private static final Selector listStatesWithCompletionHandler$ = Selector.register("listStatesWithCompletionHandler:conflictHandler:");
    @Bridge private native static void objc_listStatesWithCompletionHandler(GPGAppStateModel __self__, Selector __cmd__, GPGAppStateListHandler completionHandler, GPGAppStateConflictHandler conflictHandler);
	public void listStatesWithCompletionHandler(GPGAppStateListHandler completionHandler, GPGAppStateConflictHandler conflictHandler){
    ...
    @Bridge private native static void objc_listStateKeysWithCompletionHandler(GPGAppStateModel __self__, Selector __cmd__, GPGAppStateListKeysHandler completionHandler);
	...
	//- (void)loadForKey:(NSNumber *)key completionHandler:(GPGAppStateLoadResultHandler)completionHandler conflictHandler:(GPGAppStateConflictHandler)conflictHandler;
	private static final Selector loadForKey$ = Selector.register("loadForKey:completionHandler:conflictHandler:");
    @Bridge private native static void objc_loadForKey(GPGAppStateModel __self__, Selector __cmd__, NSNumber key, GPGAppStateLoadResultHandler completionHandler, GPGAppStateConflictHandler conflictHandler);
	...
	//- (void)updateForKey:(NSNumber *)key completionHandler:(GPGAppStateWriteResultHandler)completionHandler conflictHandler:(GPGAppStateConflictHandler)conflictHandler;
	private static final Selector updateForKey$ = Selector.register("updateForKey:completionHandler:conflictHandler:");
    @Bridge private native static void objc_updateForKey(GPGAppStateModel __self__, Selector __cmd__, NSNumber key, GPGAppStateWriteResultHandler completionHandler, GPGAppStateConflictHandler conflictHandler);
	 ...
	 * @param completionHandler The block to call when the AppState is finished downloading. ^(GPGAppStateWriteStatus status, NSError *error)
	 * @param conflictHandler The block to call if there is a conflict. ^(NSNumber *key, NSData *localState, NSData *remoteState) Return your resolved data from this callback to apply it. */
	...
	//- (void)clearForKey:(NSNumber *)key completionHandler:(GPGAppStateWriteResultHandler)completionHandler conflictHandler:(GPGAppStateConflictHandler)conflictHandler;
	private static final Selector clearForKey$ = Selector.register("clearForKey:completionHandler:conflictHandler:");
    @Bridge private native static void objc_clearForKey(GPGAppStateModel __self__, Selector __cmd__, NSNumber key, GPGAppStateWriteResultHandler completionHandler, GPGAppStateConflictHandler conflictHandler);
    ...
    @Bridge private native static void objc_deleteForKey(GPGAppStateModel __self__, Selector __cmd__, NSNumber key, GPGAppStateWriteResultHandler completionHandler);
