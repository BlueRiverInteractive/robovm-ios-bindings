...
public class GPGAppStateListInfo extends NSObject{
    ...
    @Bridge private native static boolean objc_dataIsStale(GPGAppStateListInfo __self__, Selector __cmd__);
    ...
    @Bridge private native static boolean objc_setDataIsStale(GPGAppStateListInfo __self__, Selector __cmd__, boolean dataIsStale);
    ...
    @Bridge private native static int objc_key(GPGAppStateListInfo __self__, Selector __cmd__);
    public int key(){
    	return objc_key(this, key$);
    }
    private static final Selector setKey$ = Selector.register("setKey:");
    @Bridge private native static boolean objc_setKey(GPGAppStateListInfo __self__, Selector __cmd__, NSNumber key);
