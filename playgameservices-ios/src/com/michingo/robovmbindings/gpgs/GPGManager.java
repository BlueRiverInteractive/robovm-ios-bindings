...
public class GPGManager extends NSObject{
    ...
    @Bridge private native static GPGManager objc_sharedInstance(ObjCClass __self__, Selector __cmd__);
    ...
    @Bridge private native static GPGApplicationModel objc_applicationModel(GPGManager __self__, Selector __cmd__);
    ...
    @Bridge private native static String objc_applicationId(GPGManager __self__, Selector __cmd__);
    ...
    @Bridge private native static boolean objc_hasAuthorizer(GPGManager __self__, Selector __cmd__);
    ...
    @Bridge private native static boolean objc_signout(GPGManager __self__, Selector __cmd__);
    ...
    @Bridge private native static void objc_signIn(GPGManager __self__, Selector __cmd__, GPPSignIn signIn, GPGReAuthenticationBlock reauthenticationBlock);
	...
	@Bridge private native static char objc_validOrientationFlags(GPGManager __self__, Selector __cmd__);
	...
	@Bridge private native static void objc_setValidOrientationFlags(GPGManager __self__, Selector __cmd__, char flags);
	...
	@Bridge private native static char objc_welcomeBackOffset(GPGManager __self__, Selector __cmd__);
	...
	@Bridge private native static void objc_setWelcomeBackOffset(GPGManager __self__, Selector __cmd__, char offset);
	...
	@Bridge private native static GPGToastPlacement objc_welcomeBackToastPlacement(GPGManager __self__, Selector __cmd__);
	...
	@Bridge private native static void objc_setWelcomeBackToastPlacement(GPGManager __self__, Selector __cmd__, GPGToastPlacement welcomeBackToastPlacement);
	...
	@Bridge private native static char objc_achievementUnlockedOffset(GPGManager __self__, Selector __cmd__);
	...
	@Bridge private native static void objc_setAchievementUnlockedOffset(GPGManager __self__, Selector __cmd__, char offset);
	...
	@Bridge private native static GPGToastPlacement objc_achievementUnlockedToastPlacement(GPGManager __self__, Selector __cmd__);
    ...
    private static final Selector setAchievementUnlockedToastPlacement$ = Selector.register("setAchievementUnlockedToastPlacement:");
	@Bridge private native static void objc_setAchievementUnlockedToastPlacement(GPGManager __self__, Selector __cmd__, GPGToastPlacement achievementUnlockedToastPlacement);
    ...
    @Bridge private native static void objc_refreshRevisionStatus(GPGManager __self__, Selector __cmd__, GPGRevisionCheckBlock revisionCheckHandler);
    ...
    @Bridge private native static GPGRevisionStatus objc_revisionStatus(GPGManager __self__, Selector __cmd__);
    ...
    @Bridge private native static boolean objc_isRevisionValid(GPGManager __self__, Selector __cmd__);
