...
public class GPGLocalPlayerRank extends NSObject{
	...
	@Bridge private native static String objc_formattedRank(GPGLocalPlayerRank __self__, Selector __cmd__);
	...
	@Bridge private native static String objc_formattedNumScores(GPGLocalPlayerRank __self__, Selector __cmd__);
	...
	@Bridge private native static long objc_numScores(GPGLocalPlayerRank __self__, Selector __cmd__);
	...
	@Bridge private native static long objc_rank(GPGLocalPlayerRank __self__, Selector __cmd__);
    public long rank(){
