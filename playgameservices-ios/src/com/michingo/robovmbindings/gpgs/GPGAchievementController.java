...
public class GPGAchievementController extends UINavigationController{
    ...
    @Bridge private native static GPGAchievementController objc_init(GPGAchievementController __self__, Selector __cmd__);
	...
	@Bridge private native static GPGAchievementControllerDelegate objc_achievementDelegate(GPGAchievementController __self__, Selector __cmd__);
	...
	@Bridge private native static void objc_setAchievementDelegate(GPGAchievementController __self__, Selector __cmd__, GPGAchievementControllerDelegate achievementDelegate);
