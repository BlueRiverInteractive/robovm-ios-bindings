...
public class GPGLeaderboardController extends UINavigationController{
    ...
    @Bridge private native static GPGLeaderboardController objc_initWithLeaderboardId(GPGLeaderboardController __self__, Selector __cmd__, NSString leaderboardId);
	...
	@Bridge private native static GPGLeaderboardTimeScope objc_timeScope(GPGLeaderboardController __self__, Selector __cmd__);
	...
	@Bridge private native static void objc_setTimeScope(GPGLeaderboardController __self__, Selector __cmd__, GPGLeaderboardTimeScope scope);
	...
	@Bridge private native static GPGLeaderboardControllerDelegate objc_leaderboardDelegate(GPGLeaderboardController __self__, Selector __cmd__);
	...
	@Bridge private native static void objc_setLeaderboardDelegate(GPGLeaderboardController __self__, Selector __cmd__, GPGLeaderboardControllerDelegate leaderboardDelegate);
