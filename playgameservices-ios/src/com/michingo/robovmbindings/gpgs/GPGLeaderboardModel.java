...
public class GPGLeaderboardModel extends NSObject{
    ...
    @Bridge private native static NSArray<GPGLeaderboardMetadata> objc_allMetadata(GPGLeaderboardModel __self__, Selector __cmd__);
    ...
    @Bridge private native static GPGLeaderboardMetadata objc_metadataForLeaderboardId(GPGLeaderboardModel __self__, Selector __cmd__, NSString leaderboardId);
