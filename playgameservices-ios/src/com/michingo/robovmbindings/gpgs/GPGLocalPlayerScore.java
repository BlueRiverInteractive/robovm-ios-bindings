...
public class GPGLocalPlayerScore extends NSObject{
	...
	@Bridge private native static GPGLocalPlayerRank objc_publicRank(GPGLocalPlayerScore __self__, Selector __cmd__);
	...
	@Bridge private native static String objc_leaderboardId(GPGLocalPlayerScore __self__, Selector __cmd__);
	...
	@Bridge private native static String objc_scoreString(GPGLocalPlayerScore __self__, Selector __cmd__);
	...
	@Bridge private native static long objc_scoreValue(GPGLocalPlayerScore __self__, Selector __cmd__);
	...
	@Bridge private native static GPGLocalPlayerRank objc_socialRank(GPGLocalPlayerScore __self__, Selector __cmd__);
	...
	@Bridge private native static long objc_writeTimestamp(GPGLocalPlayerScore __self__, Selector __cmd__);
