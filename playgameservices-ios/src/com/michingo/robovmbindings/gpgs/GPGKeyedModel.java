...
public class GPGKeyedModel extends NSObject{
	...
	@Bridge private native static void objc_loadDataForKey(GPGKeyedModel __self__, Selector __cmd__, NSString key);
	...
	@Bridge private native static void objc_loadDataForKey2(GPGKeyedModel __self__, Selector __cmd__, NSString key, GPGModelDidLoadBlock completionHandler);
	...
	@Bridge private native static void objc_reloadDataForKey(GPGKeyedModel __self__, Selector __cmd__, NSString key);
	...
	@Bridge private native static void objc_reloadDataForKey2(GPGKeyedModel __self__, Selector __cmd__, NSString key, GPGModelDidLoadBlock completionHandler);
	...
	@Bridge private native static boolean objc_isLoadingDataForKey(GPGKeyedModel __self__, Selector __cmd__, NSString key);
	...
	@Bridge private native static boolean objc_isDataLoadedForKey(GPGKeyedModel __self__, Selector __cmd__, NSString key);
	...
	@Bridge private native static NSError objc_errorFromLoadingDataForKey(GPGKeyedModel __self__, Selector __cmd__, NSString key);
