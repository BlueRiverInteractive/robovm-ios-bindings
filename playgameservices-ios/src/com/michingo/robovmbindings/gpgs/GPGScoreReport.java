...
public class GPGScoreReport extends NSObject{
	...
	@Bridge private native static boolean objc_isHighScoreForLocalPlayerToday(GPGScoreReport __self__, Selector __cmd__);
	...
	@Bridge private native static boolean objc_isHighScoreForLocalPlayerThisWeek(GPGScoreReport __self__, Selector __cmd__);
	...
	@Bridge private native static boolean objc_isHighScoreForLocalPlayerAllTime(GPGScoreReport __self__, Selector __cmd__);
	...
	@Bridge private native static NSString objc_leaderboardId(GPGScoreReport __self__, Selector __cmd__);
	...
	@Bridge private native static long objc_reportedScoreValue(GPGScoreReport __self__, Selector __cmd__);
	...
	@Bridge private native static GPGScore objc_highScoreForLocalPlayerToday(GPGScoreReport __self__, Selector __cmd__);
	...
	@Bridge private native static GPGScore objc_highScoreForLocalPlayerThisWeek(GPGScoreReport __self__, Selector __cmd__);
	...
	@Bridge private native static GPGScore objc_highScoreForLocalPlayerAllTime(GPGScoreReport __self__, Selector __cmd__);
