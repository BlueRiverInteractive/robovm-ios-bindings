...
public class GPGLeaderboard extends NSObject{
	...
	@Bridge private native static GPGAchievement objc_initWithLeaderboardId(GPGLeaderboard __self__, Selector __cmd__, NSString leaderboardId);
	...
	@Bridge private native static GPGLeaderboard objc_leaderboardWithId(ObjCClass __self__, Selector __cmd__, NSString leaderboardId);
	...
	@Bridge private native static String objc_leaderboardId(GPGLeaderboard __self__, Selector __cmd__);
	...
	@Bridge private native static boolean objc_personalWindow(GPGLeaderboard __self__, Selector __cmd__);
	...
	@Bridge private native static void objc_setPersonalWindow(GPGLeaderboard __self__, Selector __cmd__, boolean personalWindow);
	...
	@Bridge private native static GPGLeaderboardTimeScope objc_timeScope(GPGLeaderboard __self__, Selector __cmd__);
	...
	@Bridge private native static void objc_setTimeScope(GPGLeaderboard __self__, Selector __cmd__, GPGLeaderboardTimeScope timeScope);
	...
	@Bridge private native static boolean objc_social(GPGLeaderboard __self__, Selector __cmd__);
	public boolean isSocial(){
    	return objc_social(this, social$);
    }
	private static final Selector setSocial$ = Selector.register("setSocial:");
	@Bridge private native static void objc_setSocial(GPGLeaderboard __self__, Selector __cmd__, boolean social);
	...
	@Bridge private native static void objc_loadScoresWithCompletionHandler(GPGLeaderboard __self__, Selector __cmd__, GPGLeaderboardLoadScoresBlock completionHandler);
	...
	private static final Selector loadNextPageOfScoresWithCompletionHandler$ = Selector.register("loadNextPageOfScoresWithCompletionHandler:");
	@Bridge private native static void objc_loadNextPageOfScoresWithCompletionHandler(GPGLeaderboard __self__, Selector __cmd__, GPGLeaderboardLoadScoresBlock completionHandler);
	...
	private static final Selector loadPreviousPageOfScoresWithCompletionHandler$ = Selector.register("loadPreviousPageOfScoresWithCompletionHandler:");
	@Bridge private native static void objc_loadPreviousPageOfScoresWithCompletionHandler(GPGLeaderboard __self__, Selector __cmd__, GPGLeaderboardLoadScoresBlock completionHandler);
	...
	@Bridge private native static boolean objc_isLoadingPreviousPage(GPGLeaderboard __self__, Selector __cmd__);
	...
	@Bridge private native static boolean objc_isLoadingNextPage(GPGLeaderboard __self__, Selector __cmd__);
	...
	@Bridge private native static NSArray<GPGScore> objc_scores(GPGLeaderboard __self__, Selector __cmd__);
	...
	@Bridge private native static GPGLocalPlayerScore objc_localPlayerScore(GPGLeaderboard __self__, Selector __cmd__);
	...
	@Bridge private native static NSString objc_name(GPGLeaderboard __self__, Selector __cmd__);
	...
	@Bridge private native static boolean objc_hasPreviousPage(GPGLeaderboard __self__, Selector __cmd__);
	...
	@Bridge private native static boolean objc_hasNextPage(GPGLeaderboard __self__, Selector __cmd__);
