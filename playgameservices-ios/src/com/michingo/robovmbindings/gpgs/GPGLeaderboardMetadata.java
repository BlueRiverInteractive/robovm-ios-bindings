...
public class GPGLeaderboardMetadata extends NSObject{
	...
	@Bridge private native static NSURL objc_iconUrl(GPGLeaderboardMetadata __self__, Selector __cmd__);
	...
	@Bridge private native static String objc_leaderboardId(GPGLeaderboardMetadata __self__, Selector __cmd__);
	...
	@Bridge private native static GPGLeaderboardOrder objc_order(GPGLeaderboardMetadata __self__, Selector __cmd__);
	...
	@Bridge private native static String objc_title(GPGLeaderboardMetadata __self__, Selector __cmd__);
    public String title(){
