...
public class GPGScore extends NSObject{
	...
	@Bridge private native static GPGScore objc_initWithLeaderboardId(GPGScore __self__, Selector __cmd__, NSString leaderboardId);
	...
	@Bridge private native static GPGScore objc_scoreWithLeaderboardId(ObjCClass __self__, Selector __cmd__, NSString leaderboardId);
	...
	@Bridge private native static String objc_leaderboardId(GPGScore __self__, Selector __cmd__);
	...
	@Bridge private native static long objc_value(GPGScore __self__, Selector __cmd__);
	public long value(){
    	return objc_value(this, value$);
    }
	private static final Selector setValue$ = Selector.register("setValue:");
	@Bridge private native static long objc_setValue(GPGScore __self__, Selector __cmd__, long value);
	...
	@Bridge private native static boolean objc_submitScores(ObjCClass __self__, Selector __cmd__, NSArray scores, GPGScoreBatchReportBlock completionHandler);
	@Deprecated public static void submitScores(NSArray scores, GPGScoreBatchReportBlock completionHandler) {
	...
	@Bridge private native static boolean objc_batchSubmitScores(ObjCClass __self__, Selector __cmd__, NSArray scores, GPGScoreReportScoreBlock completionHandler);
	...
	@Bridge private native static String objc_formattedRank(GPGScore __self__, Selector __cmd__);
	...
	@Bridge private native static String objc_formattedScore(GPGScore __self__, Selector __cmd__);
	...
	@Bridge private native static long objc_rank(GPGScore __self__, Selector __cmd__);
    public long rank(){
	...
	@Bridge private native static String objc_playerId(GPGScore __self__, Selector __cmd__);
	...
	@Bridge private native static String objc_displayName(GPGScore __self__, Selector __cmd__);
	...
	@Bridge private native static NSURL objc_avatarUrl(GPGScore __self__, Selector __cmd__);
