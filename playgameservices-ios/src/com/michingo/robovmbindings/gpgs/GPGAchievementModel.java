...
public class GPGAchievementModel extends NSObject{
    ...
    @Bridge private native static NSArray<GPGAchievementMetadata> objc_allMetadata(GPGAchievementModel __self__, Selector __cmd__);
    ...
    @Bridge private native static GPGAchievementMetadata objc_metadataForAchievementId(GPGAchievementModel __self__, Selector __cmd__, NSString achievementId);
    ...
    @Bridge private native static GPGAchievementNotificationQueue objc_achievementNotificationQueue(GPGAchievementModel __self__, Selector __cmd__);
	public GPGAchievementNotificationQueue achievementNotificationQueue(){
    	return objc_achievementNotificationQueue(this, achievementNotificationQueue$);
    }*/
    ...
    @Bridge private native static void objc_queueAchievementNotification(GPGAchievementModel __self__, Selector __cmd__, GPGAchievementMetadata achievement);
