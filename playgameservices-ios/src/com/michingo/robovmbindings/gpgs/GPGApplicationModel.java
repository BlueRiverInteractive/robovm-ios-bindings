...
public class GPGApplicationModel extends GPGKeyedModel{
	...
	@Bridge private native static GPGApplicationModel objc_initWithApplicationId(GPGApplicationModel __self__, Selector __cmd__, NSString applicationId);
	...
	@Bridge private native static GPGAchievementModel objc_achievement(GPGApplicationModel __self__, Selector __cmd__);
	...
	@Bridge private native static GPGGameMetadataModel objc_application(GPGApplicationModel __self__, Selector __cmd__);
	...
	@Bridge private native static GPGLeaderboardModel objc_leaderboard(GPGApplicationModel __self__, Selector __cmd__);
	...
	@Bridge private native static GPGPlayerModel objc_player(GPGApplicationModel __self__, Selector __cmd__);
	...
	@Bridge private native static GPGAppStateModel objc_appState(GPGApplicationModel __self__, Selector __cmd__);
