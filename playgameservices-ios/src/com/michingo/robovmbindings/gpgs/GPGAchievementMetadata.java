...
public class GPGAchievementMetadata extends NSObject{
	...
	@Bridge private native static String objc_achievementId(GPGAchievementMetadata __self__, Selector __cmd__);
	...
	@Bridge private native static GPGAchievementState objc_state(GPGAchievementMetadata __self__, Selector __cmd__);
	...
	@Bridge private native static GPGAchievementType objc_type(GPGAchievementMetadata __self__, Selector __cmd__);
	...
	@Bridge private native static String objc_name(GPGAchievementMetadata __self__, Selector __cmd__);
    public String name(){
	...
	@Bridge private native static String objc_achievementDescription(GPGAchievementMetadata __self__, Selector __cmd__);
	...
	@Bridge private native static NSURL objc_revealedIconUrl(GPGAchievementMetadata __self__, Selector __cmd__);
	...
	@Bridge private native static NSURL objc_unlockedIconUrl(GPGAchievementMetadata __self__, Selector __cmd__);
	...
	@Bridge private native static int objc_completedSteps(GPGAchievementMetadata __self__, Selector __cmd__);
	...
	@Bridge private native static int objc_numberOfSteps(GPGAchievementMetadata __self__, Selector __cmd__);
	...
	@Bridge private native static String objc_formattedCompletedSteps(GPGAchievementMetadata __self__, Selector __cmd__);
	...
	@Bridge private native static String objc_formattedNumberOfSteps(GPGAchievementMetadata __self__, Selector __cmd__);
	...
	@Bridge private native static long objc_lastUpdatedTimestamp(GPGAchievementMetadata __self__, Selector __cmd__);
	...
	@Bridge private native static float objc_progress(GPGAchievementMetadata __self__, Selector __cmd__);
