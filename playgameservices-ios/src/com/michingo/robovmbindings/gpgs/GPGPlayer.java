...
public class GPGPlayer extends NSObject{
	...
	@Bridge private native static NSURL objc_avatarUrl(GPGPlayer __self__, Selector __cmd__);
	...
	@Bridge private native static String objc_name(GPGPlayer __self__, Selector __cmd__);
    public String name(){
	...
	@Bridge private native static String objc_playerId(GPGPlayer __self__, Selector __cmd__);
