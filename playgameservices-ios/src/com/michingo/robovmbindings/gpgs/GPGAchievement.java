...
public class GPGAchievement extends NSObject{
	...
	@Bridge private native static GPGAchievement objc_initWithAchievementId(GPGAchievement __self__, Selector __cmd__, NSString achievementId);
	...
	@Bridge private native static GPGAchievement objc_achievementWithId(ObjCClass __self__, Selector __cmd__, NSString achievementId);
	...
	@Bridge private native static String objc_getAchievementId(GPGAchievement __self__, Selector __cmd__);
	...
	@Bridge private native static boolean objc_getShowsCompletionNotification(GPGAchievement __self__, Selector __cmd__);
	...
	@Bridge private native static void objc_setShowsCompletionNotification(GPGAchievement __self__, Selector __cmd__, boolean showsCompletionNotification);
	...
	private static final Selector unlockAchievementWithCompletionHandler$ = Selector.register("unlockAchievementWithCompletionHandler:");
	@Bridge private native static void objc_unlockAchievementWithCompletionHandler(GPGAchievement __self__, Selector __cmd__, GPGAchievementDidUnlockBlock completionHandler);
	 ...
	 * @param completionHandler (optional) A block of the form: ^(BOOL newlyUnlocked, NSError *error). newlyUnlocked will be YES if the achievement was newly unlocked after this request was made. */
	...
	private static final Selector revealAchievementWithCompletionHandler$ = Selector.register("revealAchievementWithCompletionHandler:");
	@Bridge private native static void objc_revealAchievementWithCompletionHandler(GPGAchievement __self__, Selector __cmd__, GPGAchievementDidRevealBlock completionHandler);
	...
	private static final Selector incrementAchievementNumSteps$ = Selector.register("incrementAchievementNumSteps:completionHandler:");
	@Bridge private native static void objc_incrementAchievementNumSteps(GPGAchievement __self__, Selector __cmd__, int steps, GPGAchievementDidIncrementBlock completionHandler);
