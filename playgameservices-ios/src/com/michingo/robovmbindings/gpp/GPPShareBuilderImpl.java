...
public class GPPShareBuilderImpl extends NSObject implements GPPShareBuilder{
	...
	@Bridge private native static GPPShareBuilderImpl objc_setURLToShare(GPPShareBuilderImpl __self__, Selector __cmd__, NSURL url);
	@Override
	...
	@Bridge private native static GPPShareBuilderImpl objc_setPrefillText(GPPShareBuilderImpl __self__, Selector __cmd__, NSString prefillText);
	@Override
...
//	                   thumbnailURL:(NSURL *)thumbnailURL;
	...
	@Bridge private native static GPPShareBuilderImpl objc_setPrefillText(GPPShareBuilderImpl __self__, Selector __cmd__, 
			NSString title, NSString description, NSURL thumbnailURL);
	@Override
	public GPPShareBuilderImpl setTitle(NSString title, NSString description,
			NSURL thumbnailURL) {
	...
	@Bridge private static native boolean objc_open(GPPShareBuilderImpl __self__, Selector __cmd__);
	@Override
	public boolean open() {
	...
	@Bridge private native static GPPShareBuilderImpl objc_setContentDeepLinkID(GPPShareBuilderImpl __self__, Selector __cmd__, NSString contentDeepLinkID);
	@Override
	...
	private static final Selector setCallToActionButtonWithLabel$ = Selector.register("setCallToActionButtonWithLabel:URL:deepLinkID:");
	@Bridge private native static GPPShareBuilderImpl objc_setCallToActionButtonWithLabel(GPPShareBuilderImpl __self__, Selector __cmd__, 
	...
	@Override
	public GPPShareBuilderImpl setCallToActionButtonWithLabel(NSString label,
			NSURL url, NSString deepLinkID) {
