...
public class GPPSignIn extends NSObject{
    ...
    @Bridge private native static GTMOAuth2Authentication objc_getAuthentication(GPPSignIn __self__, Selector __cmd__);
	...
	@Bridge private native static NSString objc_getIdToken(GPPSignIn __self__, Selector __cmd__);
	...
	@Bridge private native static NSString objc_getUserEmail(GPPSignIn __self__, Selector __cmd__);
	...
	@Bridge private native static GTLPlusPerson objc_getGooglePlusUser(GPPSignIn __self__, Selector __cmd__);
    public GTLPlusPerson getGooglePlusUser(){
    	return objc_getGooglePlusUser(this, googlePlusUser$);
    }*/
	...
	@Bridge private native static void objc_setDelegate(GPPSignIn __self__, Selector __cmd__, GPPSignInDelegate del);
	...
	@Bridge private native static void objc_setClientID(GPPSignIn __self__, Selector __cmd__, NSString clientID);
	...
	@Bridge private native static void objc_setHomeClientID(GPPSignIn __self__, Selector __cmd__, NSString homeClientID);
 ...
 //@property(nonatomic, copy) NSArray *scopes;
	...
	@Bridge private native static NSArray<NSString> objc_scopes(GPPSignIn __self__, Selector __cmd__);
	...
	@Bridge private native static void objc_setScopes(GPPSignIn __self__, Selector __cmd__, NSArray<NSString> scopes);
 ...
 //@property(nonatomic, assign) BOOL attemptSSO;
	...
	@Bridge private native static void objc_setAttemptSSO(GPPSignIn __self__, Selector __cmd__, boolean attemptSSO);
 ...
 //@property(nonatomic, copy) NSString *language;
	...
	@Bridge private native static void objc_setLanguage(GPPSignIn __self__, Selector __cmd__, String language);
 ...
 //@property(nonatomic, copy) NSString *keychainName;
	...
	@Bridge private native static void objc_setKeychainName(GPPSignIn __self__, Selector __cmd__, String name);
 ...
 //@property(nonatomic, copy) NSArray *actions;
	...
	@Bridge private native static void objc_setActions(GPPSignIn __self__, Selector __cmd__, NSArray actions);
 ...
 //@property(nonatomic, assign) BOOL shouldFetchGoogleUserEmail;
	...
	@Bridge private native static void objc_setShouldFetchGoogleUserEmail(GPPSignIn __self__, Selector __cmd__, boolean fetch);
 ...
 //@property(nonatomic, assign) BOOL shouldFetchGoogleUserID;
	...
	@Bridge private native static void objc_setShouldFetchGoogleUserID(GPPSignIn __self__, Selector __cmd__, boolean fetch);
 ...
 //@property(nonatomic, assign) BOOL shouldFetchGooglePlusUser;
	...
	@Bridge private native static void objc_setShouldFetchGooglePlusUser(GPPSignIn __self__, Selector __cmd__, boolean fetch);
    ...
    @Bridge private native static GPPSignIn objc_sharedInstance(ObjCClass __self__, Selector __cmd__);
	...
	@Bridge private native static boolean objc_hasAuthInKeychain(GPPSignIn __self__, Selector __cmd__);
	...
	@Bridge private native static boolean objc_trySilentAuthentication(GPPSignIn __self__, Selector __cmd__);
	...
	@Bridge private native static void objc_authenticate(GPPSignIn __self__, Selector __cmd__);
	...
	@Bridge private native static void objc_signOut(GPPSignIn __self__, Selector __cmd__);
	public void signOut() {
	...
	@Bridge private native static void objc_disconnect(GPPSignIn __self__, Selector __cmd__);
	...
	@Bridge private native static GTLServicePlus objc_plusService(GPPSignIn __self__, Selector __cmd__);
	public GTLServicePlus plusService() {
		return objc_plusService(this, plusService$);
	}*/
}