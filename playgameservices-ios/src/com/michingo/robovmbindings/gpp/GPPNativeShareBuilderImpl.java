...
public class GPPNativeShareBuilderImpl extends GPPShareBuilderImpl implements GPPNativeShareBuilder{
	...
	@Bridge private native static GPPNativeShareBuilderImpl objc_attachImage(GPPNativeShareBuilderImpl __self__, Selector __cmd__, UIImage imageAttachment);
	@Override
	...
	@Bridge private native static GPPNativeShareBuilderImpl objc_attachImageData(GPPNativeShareBuilderImpl __self__, Selector __cmd__, NSData imageData);
	@Override
	...
	@Bridge private native static GPPNativeShareBuilderImpl objc_attachVideoURL(GPPNativeShareBuilderImpl __self__, Selector __cmd__, NSURL videoAttachment);
	@Override
	...
	@Bridge private native static GPPNativeShareBuilderImpl objc_setPreselectedPeopleIDs(GPPNativeShareBuilderImpl __self__, Selector __cmd__,
			NSArray preselectedPeopleIDs);
	@Override
	public GPPNativeShareBuilderImpl setPreselectedPeopleIDs(
			NSArray preselectedPeopleIDs) {
