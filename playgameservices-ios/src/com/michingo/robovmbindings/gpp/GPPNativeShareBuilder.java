...
public interface GPPNativeShareBuilder extends NSObjectProtocol {
	...
	public static class Adapter extends NSObject implements GPPNativeShareBuilder {
		...
		@Override
		public GPPNativeShareBuilder setPreselectedPeopleIDs(
	...
	static class Callbacks {
		...
		public static GPPNativeShareBuilder objc_attachImage(GPPNativeShareBuilder __self__, Selector __cmd__, UIImage imageAttachment){
		...
		public static GPPNativeShareBuilder objc_attachVideoURL(GPPNativeShareBuilder __self__, Selector __cmd__, NSURL videoAttachment){
		...
		public static GPPNativeShareBuilder objc_setPreselectedPeopleIDs(GPPNativeShareBuilder __self__, Selector __cmd__, NSArray preselectedPeopleIDs){
