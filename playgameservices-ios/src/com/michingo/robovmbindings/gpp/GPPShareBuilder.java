...
//	deepLinkID:(NSString *)deepLinkID;
	...
	public static class Adapter extends NSObject implements GPPShareBuilder {
		...
		public GPPShareBuilder setTitle(NSString title, NSString description,
				NSURL thumbnailURL) {
			// TODO Auto-generated method stub
			return null;
		}
		...
		public GPPShareBuilder setCallToActionButtonWithLabel(NSString label,
	...
	static class Callbacks {
		...
		public static GPPShareBuilder objc_setTitle(GPPShareBuilder __self__, Selector __cmd__, 
		...
		public static GPPShareBuilder objc_setCallToActionButtonWithLabel(GPPShareBuilder __self__, Selector __cmd__, NSString label,
				NSURL url, NSString deepLinkID){
...
//@Bridge private native static GPPShareBuilder objc_setPrefillText(GPPShareBuilder __self__, Selector __cmd__, NSString prefillText);
//public GPPShareBuilder setPrefillText(NSString prefillText) {
