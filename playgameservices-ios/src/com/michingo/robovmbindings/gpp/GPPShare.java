...
public class GPPShare extends NSObject{
    ...
    @Bridge private native static GPPShareDelegate objc_getDelegate(GPPShare __self__, Selector __cmd__);
	...
	@Bridge private native static GPPShareBuilderImpl objc_shareDialog(GPPShare __self__, Selector __cmd__);
