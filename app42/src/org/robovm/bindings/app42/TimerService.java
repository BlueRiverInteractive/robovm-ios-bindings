...
public class TimerService extends App42Service
{
	...
	public native void createOrUpdateTimer(String timerName, long timeInSeconds, @Block App42ResponseBlock completionBlock);

	@Method(selector = "startTimerWithName:forUser:completionBlock:")
	public native void startTimer(String timerName, String userName, @Block App42ResponseBlock completionBlock);
	...
	public native void cancelTimer(String timerName, String userName, @Block App42ResponseBlock completionBlock);
	
	@Method(selector = "deleteTimerWithName:completionBlock:")
	public native void deleteTimer(String timerName, @Block App42ResponseBlock completionBlock);
