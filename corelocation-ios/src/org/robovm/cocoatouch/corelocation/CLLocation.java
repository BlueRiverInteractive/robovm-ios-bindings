...
public class CLLocation extends NSObject {
	...
	@Bridge
	private native static CLLocationCoordinate2D objc_coordinate (CLLocation __self__, Selector __cmd__);
	...
	@Bridge
	private native static double objc_horizontalAccuracy (CLLocation __self__, Selector __cmd__);
