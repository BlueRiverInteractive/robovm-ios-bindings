...
public class CLLocationManager extends NSObject {
	...
	@Bridge
	private native static boolean objc_locationServicesEnabled (ObjCClass __self__, Selector __cmd__);
	...
	@Bridge
	private native static CLAuthorizationStatus objc_authorizationStatus (ObjCClass __self__, Selector __cmd__);
	...
	@Bridge
	private native static CLLocation objc_location (CLLocationManager __self__, Selector __cmd__);
	...
	@Bridge
	private native static void objc_setDistanceFilter (CLLocationManager __self__, Selector __cmd__, double distanceFilter);
	...
	@Bridge
	private native static void objc_setDesiredAccuracy (CLLocationManager __self__, Selector __cmd__, double desiredAccuracy);
	...
	@Bridge
	private native static void objc_setDelegate (CLLocationManager __self__, Selector __cmd__, CLLocationManagerDelegate del);
	...
	@Bridge
	private native static void objc_startUpdatingLocation (CLLocationManager __self__, Selector __cmd__);
	...
	@Bridge
	private native static void objc_stopUpdatingLocation (CLLocationManager __self__, Selector __cmd__);
