...
public class Sample extends UIApplicationDelegateAdapter implements GPPSignInDelegate, GPGAchievementControllerDelegate,
    ...
    public void didFinishLaunching (UIApplication application) {
        ...
        tv.setBackgroundColor(UIColor.white());
        tv.setTextColor(UIColor.black());
        ...
        b5tl = new OnTouchUpInsideListener() {
            ...
            public void onTouchUpInside (UIControl control, UIEvent event) {
                if (signedIn) {
                     ...
                     * 
                     * //display all achievements for(int i=0;i<arr.size();i++){
...
// com.michingo.robovmbindings.gpgs.GPGLeaderboardMetadata
                    ...
                    /*
                     * //obtain all metadata for the leaderboards NSArray<GPGLeaderboardMetadata> allLeaderboards =
                     * .allMetadata();
                     * 
