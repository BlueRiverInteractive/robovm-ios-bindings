...
/**
 * The delegate of an {@link MPAdView} object must adopt the MPAdViewDelegate protocol. It must implement {@link #getViewController()} to provide a
 * root view controller from which the ad view should present modal content.
 * 
 * Optional methods of this protocol allow the delegate to be notified of banner success or failure, as well as other lifecycle events.
 * 
...
public interface MPAdViewDelegate extends NSObjectProtocol {
	 ...
	 * 
	 * This method is called when the user taps on the ad view. Your implementation of this method should pause any application activity that requires
	 * user interaction.
	 * 
	 * @param view
	 *            The ad view sending the message.
	 ...
	 * 
	 * Your implementation of this method should resume any application activity that was paused in response to `willPresentModalViewForAd:`.
	 * 
	 * @param view
	 *            The ad view sending the message.
	 * @see #willPresentView
