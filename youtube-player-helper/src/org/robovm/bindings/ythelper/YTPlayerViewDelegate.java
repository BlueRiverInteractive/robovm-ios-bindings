...
/** A delegate for ViewControllers to respond to YouTube player events outside of the view, such as changes to video playback state
 * or playback errors. The callback functions correlate to the events fired by the JavaScript API. For the full documentation, see
 * the JavaScript documentation here: https://developers.google.com/youtube/js_api_reference#Events */
