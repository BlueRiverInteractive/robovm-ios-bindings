...
public class GameCenterManager {
	...
	/**
	 * Do the login logic. If the user has never loged, a dialog will be shown.
	 * This method is for use in LibGDX. It uses a fix in order to show the login dialog 
	 */
	...
	/**
	 * Load all the Leaderboards for the Game.
	 * Warning: If using iOS5 or less the Leaderboard object will only include the Category (identifier)
	 */
