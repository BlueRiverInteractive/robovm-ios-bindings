...
public class GKGameCenterViewController extends UINavigationController{
    ...
    @Bridge
    private native static void objc_setGameCenterDelegate(GKGameCenterViewController __self__, Selector __cmd__, GKGameCenterControllerDelegate delegate);

    @Bridge
    private native static void objc_setGameCenterDelegateSuper(ObjCSuper __super__, Selector __cmd__, GKGameCenterControllerDelegate delegate);
    ...
    @Bridge
    private native static void objc_setViewState(GKGameCenterViewController __self__, Selector __cmd__, GKGameCenterViewControllerState viewState);

    @Bridge
    private native static void objc_setViewStateSuper(ObjCSuper __super__, Selector __cmd__, GKGameCenterViewControllerState viewState);
    ...
    //@property (nonatomic, assign)   GKLeaderboardTimeScope                  leaderboardTimeScope __OSX_AVAILABLE_BUT_DEPRECATED_MSG(NA, NA, __IPHONE_4_1, __IPHONE_7_0, "GKGameCenterViewController no longer supports leaderboard time scopes. Will always default to GKLeaderboardTimeScopeAllTime.");
    private static final Selector setLeaderboardTimeScope = Selector.register("setLeaderboardTimeScope:");

    @Bridge
    private native static void objc_setLeaderboardTimeScope(GKGameCenterViewController __self__, Selector __cmd__, GKLeaderboardTimeScope leaderboardTimeScope);

    @Bridge
    private native static void objc_setLeaderboardTimeScopeSuper(ObjCSuper __super__, Selector __cmd__, GKLeaderboardTimeScope leaderboardTimeScope);
    ...
    @Bridge
    private native static void objc_setLeaderboardIdentifier(GKGameCenterViewController __self__, Selector __cmd__, String leaderboardIdentifier);

    @Bridge
    private native static void objc_setLeaderboardIdentifierSuper(ObjCSuper __super__, Selector __cmd__, String leaderboardIdentifier);
    ...
    //@property (nonatomic, retain)   NSString *leaderboardCategory __OSX_AVAILABLE_BUT_DEPRECATED(__MAC_10_8, __MAC_NA, __IPHONE_4_1, __IPHONE_7_0);
    private static final Selector setLeaderboardCategory = Selector.register("setLeaderboardCategory:");

    @Bridge
    private native static void objc_setLeaderboardCategory(GKGameCenterViewController __self__, Selector __cmd__, String leaderboardCategory);
