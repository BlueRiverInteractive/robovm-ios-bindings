...
public class GKLeaderboard extends NSObject {
	...
	@Bridge private native static void objc_init(GKLeaderboard __self__, Selector __cmd__);

	@Bridge private native static void objc_initSuper(ObjCSuper __super__, Selector __cmd__);
	...
	@Bridge private native static void objc_init(GKLeaderboard __self__, Selector __cmd__, NSArray playerIDs);

	@SuppressWarnings("rawtypes")
	@Bridge private native static void objc_initSuper(ObjCSuper __super__, Selector __cmd__, NSArray playerIDs);

	/**
	 * Specify an array of players ids, for example, the players who are in a match together
	 * Defaults to AllTime score, if you want to change the timeScope, set the property before loading the scores. 
	 * Range and playerScope are not applicable. playerIDs may not be nil.
	 * @param identifier
	 */
	@SuppressWarnings("rawtypes")
	...
	@Bridge private native static GKLeaderboardTimeScope objc_timeScope(GKLeaderboard __self__, Selector __cmd__);
	@Bridge private native static GKLeaderboardTimeScope objc_timeScopeSuper(ObjCSuper __super__, Selector __cmd__);
	...
	@Bridge private native static void objc_setTimeScope(GKLeaderboard __self__, Selector __cmd__, GKLeaderboardTimeScope timeScope);
	@Bridge private native static void objc_setTimeScopeSuper(ObjCSuper __super__, Selector __cmd__, GKLeaderboardTimeScope timeScope);
	...
	@Bridge private native static GKLeaderboardPlayerScope objc_playerScope(GKLeaderboard __self__, Selector __cmd__);
	@Bridge private native static GKLeaderboardPlayerScope objc_playerScopeSuper(ObjCSuper __super__, Selector __cmd__);
	...
	@Bridge private native static void objc_setPlayerScope(GKLeaderboard __self__, Selector __cmd__, GKLeaderboardPlayerScope playerScope);
	@Bridge private native static void objc_setPlayerScopeSuper(ObjCSuper __super__, Selector __cmd__, GKLeaderboardPlayerScope playerScope);
	...
	@Bridge private native static String objc_category(GKLeaderboard __self__, Selector __cmd__);
	@Bridge private native static String objc_categorySuper(ObjCSuper __super__, Selector __cmd__);
	...
	@Bridge private native static void objc_setCategory(GKLeaderboard __self__, Selector __cmd__, String category);
	@Bridge private native static void objc_setCategorySuper(ObjCSuper __super__, Selector __cmd__, String category);
	...
	@Bridge private native static String objc_identifier(GKLeaderboard __self__, Selector __cmd__);
	@Bridge private native static String objc_identifierSuper(ObjCSuper __super__, Selector __cmd__);
	...
	@Bridge private native static void objc_setIdentifier(GKLeaderboard __self__, Selector __cmd__, String identifier);
	@Bridge private native static void objc_setIdentifierSuper(ObjCSuper __super__, Selector __cmd__, String identifier);
	...
	@Bridge private native static String objc_title(GKLeaderboard __self__, Selector __cmd__);
	@Bridge private native static String objc_titleSuper(ObjCSuper __super__, Selector __cmd__);
	...
	@Bridge private native static NSRange objc_range(GKLeaderboard __self__, Selector __cmd__);
	@Bridge private native static NSRange objc_rangeSuper(ObjCSuper __super__, Selector __cmd__);
	
	/**
	 * Getter - 
	 * Leaderboards start at index 1 and the length should be less than 100. 
	 * Does not apply to leaderboards initialized with players.  
	 * Exception will be thrown if developer tries to set an invalid range
	 * @return
	 */
	...
	@Bridge private native static void objc_setRange(GKLeaderboard __self__, Selector __cmd__, NSRange range);
	@Bridge private native static void objc_setRangeSuper(ObjCSuper __super__, Selector __cmd__, NSRange range);
	...
	@SuppressWarnings("rawtypes")
	@Bridge private native static NSArray objc_scores(GKLeaderboard __self__, Selector __cmd__);
	@SuppressWarnings("rawtypes")
	@Bridge private native static NSArray objc_scoresSuper(ObjCSuper __super__, Selector __cmd__);
	...
	@Bridge private native static int objc_maxRange(GKLeaderboard __self__, Selector __cmd__);
	@Bridge private native static int objc_maxRangeSuper(ObjCSuper __super__, Selector __cmd__);
	...
	@Bridge private native static GKScore objc_localPlayerScore(GKLeaderboard __self__, Selector __cmd__);
	@Bridge private native static GKScore objc_localPlayerScoreSuper(ObjCSuper __super__, Selector __cmd__);
	...
	@Bridge private native static boolean objc_isLoading(GKLeaderboard __self__, Selector __cmd__);
	...
	@Bridge private native static String objc_groupIdentifier(GKLeaderboard __self__, Selector __cmd__);
	@Bridge private native static String objc_groupIdentifierSuper(ObjCSuper __super__, Selector __cmd__);
	
	/**
	 * Getter - 
	 * set when leaderboards have been designated a game group; 
	 * set when loadLeaderboardsWithCompletionHandler has been called for leaderboards that support game groups
	 * @return
	 */
	...
	@Bridge private native static void objc_loadScoresWithCompletionHandler(GKLeaderboard __self__, Selector __cmd__, VoidNSArrayNSErrorBlock completionHandler);
	@Bridge private native static void objc_loadScoresWithCompletionHandlerSuper(ObjCSuper __super__, Selector __cmd__, VoidNSArrayNSErrorBlock completionHandler);
	...
	@Bridge private native static void objc_loadCategories(ObjCClass __self__, Selector __cmd__, VoidNSArrayNSArrayNSErrorBlock completionHandler);
	...
	private static final Selector loadLeaderboardsWithCompletionHandler = Selector.register("loadLeaderboardsWithCompletionHandler:");
	
	@Bridge private native static void objc_loadLeaderboards(ObjCClass __self__, Selector __cmd__, VoidNSArrayNSErrorBlock completionHandler);
	...
	private static final Selector setDefaultLeaderboard$withCompletionHandler = Selector.register("setDefaultLeaderboard:withCompletionHandler:");
	
	@Bridge private native static void objc_setDefaultLeaderboard(ObjCClass __self__, Selector __cmd__, String leaderboardIdentifier, VoidNSErrorBlock completionHandler);
