...
public class GKLocalPlayer extends NSObject{
    ...
    @Bridge private native static GKLocalPlayer objc_localPlayer(ObjCClass __self__, Selector __cmd__);
    ...
    @Bridge private native static boolean objc_isAuthenticated(GKLocalPlayer __self__, Selector __cmd__);
    @Bridge private native static boolean objc_isAuthenticatedSuper(ObjCSuper __super__, Selector __cmd__);
    ...
    @Bridge private native static boolean objc_isUnderage(GKLocalPlayer __self__, Selector __cmd__);
    @Bridge private native static boolean objc_isUnderageSuper(ObjCSuper __super__, Selector __cmd__);
    ...
    @Bridge private native static void objc_setAuthenticateHandler(GKLocalPlayer __self__, Selector __cmd__, VoidUIViewControllerNSErrorBlock authenticateHandlerBlock);
    @Bridge private native static void objc_setAuthenticateHandlerSuper(ObjCSuper __super__, Selector __cmd__, VoidUIViewControllerNSErrorBlock authenticateHandlerBlock);
    
    /**
     * The authenticate handler will be called whenever the authentication process finishes or needs to show UI. 
     * The handler may be called multiple times. Authentication will happen automatically when the handler is first set and whenever the app returns to the foreground.
     * If the authentication process needs to display UI the viewController property will be non-nil. 
     * Your application should present this view controller and continue to wait for another call of the authenticateHandler.  
     * The view controller will be dismissed automatically.
	...
	@Bridge private native static NSArray objc_friends(GKLocalPlayer __self__, Selector __cmd__);
    @SuppressWarnings("rawtypes")
	@Bridge private native static NSArray objc_friendsSuper(ObjCSuper __super__, Selector __cmd__);
    
    /**
     * Array of player identifiers of friends for the local player. 
     * Not valid until loadFriendsWithCompletionHandler: has completed.
     * @return
     */
    @SuppressWarnings("rawtypes")
    ...
    @Bridge private native static void objc_authenticateWithCompletionHandler(GKLocalPlayer __self__, Selector __cmd__, VoidNSErrorBlock completionHandler);
    @Bridge private native static void objc_authenticateWithCompletionHandlerSuper(ObjCSuper __super__, Selector __cmd__, VoidNSErrorBlock completionHandler);
    
    /**
     * Deprecated, set the authenticateHandler instead. 
     * Authentication happens automatically when the handler is set and when the app returns to foreground.
