...
public class GKLeaderboardViewController extends GKGameCenterViewController{
    ...
    @Bridge
    private native static void objc_setLeaderboardDelegate(GKLeaderboardViewController __self__, Selector __cmd__, GKLeaderboardViewControllerDelegate leaderboardDelegate);

    @Bridge
    private native static void objc_setLeaderboardDelegateSuper(ObjCSuper __super__, Selector __cmd__, GKLeaderboardViewControllerDelegate leaderboardDelegate);
    ...
    @Bridge
    private native static void objc_setTimeScope(GKLeaderboardViewController __self__, Selector __cmd__, GKLeaderboardTimeScope timeScope);
