...
public class GKScore extends NSObject {
	...
	@Bridge private native static @Pointer long objc_initWithLeaderboardIdentifier(GKScore __self__, Selector __cmd__, String identifier);
	@Bridge private native static @Pointer long objc_initWithCategory(GKScore __self__, Selector __cmd__, String category);
	...
	private static final Selector initWithLeaderboardIdentifier$forPlayer = Selector.register("initWithLeaderboardIdentifier:forPlayer:");
	
	@Bridge private native static @Pointer long objc_init(GKScore __self__, Selector __cmd__, String identifier, String playerID);
	...
	@Bridge private native static long objc_value(GKScore __self__, Selector __cmd__);
	@Bridge private native static long objc_valueSuper(ObjCSuper __super__, Selector __cmd__);
	...
	@Bridge private native static void objc_setValue(GKScore __self__, Selector __cmd__, long value);
	@Bridge private native static void objc_setValueSuper(ObjCSuper __super__, Selector __cmd__, long value);
	...
	@Bridge private native static String objc_formattedValue(GKScore __self__, Selector __cmd__);
	@Bridge private native static String objc_formattedValueSuper(ObjCSuper __super__, Selector __cmd__);
	...
	@Bridge private native static String objc_category(GKScore __self__, Selector __cmd__);
	...
	@Bridge private native static void objc_setCategory(GKScore __self__, Selector __cmd__, String category);
	...
	@Bridge private native static String objc_leaderboardIdentifier(GKScore __self__, Selector __cmd__);
	@Bridge private native static String objc_leaderboardIdentifierSuper(ObjCSuper __super__, Selector __cmd__);
	...
	@Bridge private native static void objc_setLeaderboardIdentifier(GKScore __self__, Selector __cmd__, String leaderboardIdentifier);
	@Bridge private native static void objc_setLeaderboardIdentifierSuper(ObjCSuper __super__, Selector __cmd__, String leaderboardIdentifier);
	...
	@Bridge private native static long objc_context(GKScore __self__, Selector __cmd__);
	@Bridge private native static long objc_contextSuper(ObjCSuper __super__, Selector __cmd__);
	...
	@Bridge private native static void objc_setContext(GKScore __self__, Selector __cmd__, long context);
	@Bridge private native static void objc_setContextSuper(ObjCSuper __super__, Selector __cmd__, long context);
	...
	@Bridge private native static NSDate objc_date(GKScore __self__, Selector __cmd__);
	@Bridge private native static NSDate objc_dateSuper(ObjCSuper __super__, Selector __cmd__);
	...
	@Bridge private native static String objc_playerID(GKScore __self__, Selector __cmd__);
	@Bridge private native static String objc_playerIDSuper(ObjCSuper __super__, Selector __cmd__);
	...
	@Bridge private native static int objc_rank(GKScore __self__, Selector __cmd__);
	@Bridge private native static int objc_rankSuper(ObjCSuper __super__, Selector __cmd__);
	...
	@Bridge private native static boolean objc_shouldSetDefaultLeaderboard(GKScore __self__, Selector __cmd__);
	@Bridge private native static boolean objc_shouldSetDefaultLeaderboardSuper(ObjCSuper __super__, Selector __cmd__);
	...
	@Bridge private native static void objc_setShouldSetDefaultLeaderboard(GKScore __self__, Selector __cmd__, boolean shouldSetDefaultLeaderboard);
	@Bridge private native static void objc_setShouldSetDefaultLeaderboardSuper(ObjCSuper __super__, Selector __cmd__, boolean shouldSetDefaultLeaderboard);
	...
	@Bridge private native static void objc_reportScores(ObjCClass __self__, Selector __cmd__, NSArray scores, VoidNSErrorBlock completionHandler);
	...
	@Bridge private native static void objc_reportScore(GKScore __self__, Selector __cmd__, VoidNSErrorBlock completionHandler);
	@Bridge private native static void objc_reportScoreSuper(ObjCSuper __super__, Selector __cmd__, VoidNSErrorBlock completionHandler);
