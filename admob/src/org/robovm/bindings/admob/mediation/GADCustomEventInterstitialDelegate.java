...
public interface GADCustomEventInterstitialDelegate extends NSObjectProtocol {
	...
	static class Callbacks {
		...
		public static void customEventDidReceiveAd (GADCustomEventInterstitialDelegate __self__, Selector __cmd__,
			GADCustomEventInterstitial customEvent, NSObject ad) {
			__self__.customEventDidReceiveAd(customEvent, ad);
		}

		@Callback
		@BindSelector("customEventInterstitial:didFailAd:")
		public static void customEventDidFailAd (GADCustomEventInterstitialDelegate __self__, Selector __cmd__,
			GADCustomEventInterstitial customEvent, NSError error) {
			__self__.customEventDidFailAd(customEvent, error);
		}

		@Callback
		@BindSelector("customEventInterstitialWillPresent:")
		public static void customEventWillPresent (GADCustomEventInterstitialDelegate __self__, Selector __cmd__,
		...
		public static void customEventWillDismiss (GADCustomEventInterstitialDelegate __self__, Selector __cmd__,
			GADCustomEventInterstitial customEvent) {
		...
		public static void customEventDidDismiss (GADCustomEventInterstitialDelegate __self__, Selector __cmd__,
			GADCustomEventInterstitial customEvent) {
		...
		public static void customEventWillLeaveApplication (GADCustomEventInterstitialDelegate __self__, Selector __cmd__,
			GADCustomEventInterstitial customEvent) {
