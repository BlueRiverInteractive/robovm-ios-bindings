...
public class GADInterstitial extends NSObject {
	...
	/** Returns YES if the interstitial is ready to be displayed. The delegate's interstitialAdDidReceiveAd: will be called when
	 * this switches from NO to YES. */
	...
	/** Returns YES if the interstitial object has already shown an interstitial. Note that an interstitial object can only be used
	...
	/** Getter for AdUnitID Required value created in the AdSense website. Create a new ad unit for every unique placement of an ad
	 * in your application. Set this to the ID assigned for this placement. Ad units are important for targeting and stats. Example
	 * values for different request types: AdMob: a0123456789ABCD DFP: /0123/ca-pub-0123456789012345/my-ad-identifier AdSense:
	...
	/** Setter for AdUnitID Required value created in the AdSense website. Create a new ad unit for every unique placement of an ad
	 * in your application. Set this to the ID assigned for this placement. Ad units are important for targeting and stats. Example
	 * values for different request types: AdMob: a0123456789ABCD DFP: /0123/ca-pub-0123456789012345/my-ad-identifier AdSense:
	 * ca-mb-app-pub-0123456789012345/my-ad-identifier */
	...
	/** Getter for Delegate Optional delegate object that receives state change notifications from this GADInterstitalAd. Remember
	 * to nil the delegate before deallocating this object.
	 * @return */
	...
	/** Setter for Delegate Optional delegate object that receives state change notifications from this GADInterstitalAd. Remember
	 * to nil the delegate before deallocating this object.
	 * @return */
	...
	private static final Selector loadAndDisplayRequest$usingWindow$initialImage = Selector
		.register("loadAndDisplayRequest:usingWindow:initialImage:");

	@Bridge
	private native static void objc_loadAndDisplayRequest (GADInterstitial __self__, Selector __cmd__, GADRequest request,
		UIWindow window, UIImage image);

	/** The |window| will be shown with the |image| displayed until either the |request| interstitial is shown or a timeout occurs.
	 * The delegate will receive an interstitialDidDismissScreen: callback to indicate that your app should continue when the
	...
	@Bridge
	private native static void objc_presentFromRootViewController (GADInterstitial __self__, Selector __cmd__,
