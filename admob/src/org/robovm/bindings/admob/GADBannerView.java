...
public class GADBannerView extends UIView {
	 ...
	 * UIViewController, however, if you are unfamiliar with the delegate pattern it is recommended you subclass this GADBannerView
	 * and make it the delegate. That avoids any chance of your application crashing if you forget to null out the delegate.
	 * @param delegate */
	@Property(strongRef = true)
	...
	/** @return the underlying ad view of the mediated ad network. You may use this to find out the actual size of the ad and adjust
