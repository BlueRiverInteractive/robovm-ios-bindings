...
public final class GADAdSizeManager extends NSObject {
	...
	public static native @ByVal
	GADAdSize getGADAdSize (CGSize size);
	...
	public static native boolean equals (GADAdSize size1, GADAdSize size2);

	/** Given a GADAdSize constant, returns a CGSize. If the GADAdSize is unknown, returns CGSizeZero.
	 * @param size
	 * @return */
	@Method(selector = "fromAdSize:")
	public static native CGSize getCGSize (GADAdSize size);
	...
	public static native boolean isValid (GADAdSize size);

	/** @return Given a GADAdSize constant, returns a NSString describing the GADAdSize. */
	@Method(selector = "toString:")
	public static native String toString (GADAdSize size);
}
