...
public interface GADCustomEventInterstitial extends NSObjectProtocol{
	 ...
	 * @param request
	 */
	void requestIntersitial(NSString serverParameter, NSString serverLabel, GADCustomEventRequest request);
	...
	public static class Adapter extends NSObject implements GADCustomEventInterstitial {
		@Override
		public void requestIntersitial(NSString serverParameter, NSString serverLabel, GADCustomEventRequest request){
		}

		@Override
		public void presentFromRootViewController(UIViewController rootViewController){
		}
	...
	static class Callbacks {
		...
		public static void requestIntersitial(GADCustomEventInterstitial __self__, Selector __cmd__, NSString serverParameter, NSString serverLabel, GADCustomEventRequest request){
			__self__.requestIntersitial(serverParameter, serverLabel, request);
		}
		
		@Callback
		@BindSelector("presentFromRootViewController:")
		public static void presentFromRootViewController(GADCustomEventInterstitial __self__, Selector __cmd__, UIViewController rootViewController){
			__self__.presentFromRootViewController(rootViewController);
		}
		...
		public static void setDelegate(GADCustomEventInterstitial __self__, Selector __cmd__, GADCustomEventInterstitialDelegate delegate){
