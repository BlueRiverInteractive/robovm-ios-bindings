...
public interface AdColonyDelegate extends NSObjectProtocol {
	...
	// - ( void ) onAdColonyV4VCReward:(BOOL)success currencyName:(String*)currencyName currencyAmount:(int)amount
// inZone:(String*)zoneID;
	...
	static class Callbacks {
		...
		public static void onAdColonyAdAvailabilityChange (AdColonyDelegate __self__, Selector __cmd__, boolean available,
			String zoneID) {
		...
		public static void onAdColonyV4VCReward (AdColonyDelegate __self__, Selector __cmd__, boolean success, String currencyName,
