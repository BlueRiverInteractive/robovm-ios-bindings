...
public interface MFMailComposeViewControllerDelegate extends NSObjectProtocol{
	...
	*/
	...
	static class Callbacks{
		...
		public static void mailComposeControllerDidFinish(MFMailComposeViewControllerDelegate __self__, Selector __cmd__, MFMailComposeViewController controller, MFMailComposeResult result, NSError error){
