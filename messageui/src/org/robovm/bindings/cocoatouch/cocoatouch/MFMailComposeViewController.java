...
public class MFMailComposeViewController extends UINavigationController{
	...
	@Bridge private native static boolean objc_canSendMail(ObjCClass __self__, Selector __cmd__);
	...
	*/
    ...
    @Bridge
    private native static void objc_setMailComposeDelegate(MFMailComposeViewController __self__, Selector __cmd__, MFMailComposeViewControllerDelegate delegate);

    @Bridge
    private native static void objc_setMailComposeDelegateSuper(ObjCSuper __super__, Selector __cmd__, MFMailComposeViewControllerDelegate delegate);
    ...
    */
	...
	@Bridge
    private native static void objc_setMessageBody(MFMailComposeViewController __self__, Selector __cmd__, String body, boolean isHTML);
	...
	*/
	...
	@Bridge
    private native static void objc_addAttachmentData(MFMailComposeViewController __self__, Selector __cmd__, NSData attachment, String mimeType, String filename);

	@Bridge
    private native static void objc_addAttachmentDataSuper(ObjCSuper __super__, Selector __cmd__, NSData attachment, String mimeType, String filename);
