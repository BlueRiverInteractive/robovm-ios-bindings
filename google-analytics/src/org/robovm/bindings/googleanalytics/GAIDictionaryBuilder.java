...
public class GAIDictionaryBuilder extends NSObject {
	...
	@Bridge
	private native static GAIDictionaryBuilder objc_set (GAIDictionaryBuilder __self__, Selector __cmd__, NSString value,
		NSString key);
	...
	@Bridge
	private native static GAIDictionaryBuilder objc_setAll (GAIDictionaryBuilder __self__, Selector __cmd__,
		GAIDictionaryBuilder params);
	...
	@Bridge
	private native static NSString objc_get (GAIDictionaryBuilder __self__, Selector __cmd__, NSString paramName);
	...
	@Bridge
	private native static NSMutableDictionary objc_build (GAIDictionaryBuilder __self__, Selector __cmd__);
	...
	@Bridge
	private native static GAIDictionaryBuilder objc_setCampaignParametersFromUrl (GAIDictionaryBuilder __self__, Selector __cmd__,
		NSString urlString);
	...
	@Bridge
	private native static GAIDictionaryBuilder objc_createAppView (ObjCClass __self__, Selector __cmd__);
	...
	@Bridge
	private native static GAIDictionaryBuilder objc_createEventWithCategory (ObjCClass __self__, Selector __cmd__,
	...
	public static GAIDictionaryBuilder createEventWithCategory (String category, String action, String label, NSNumber value) {
		return objc_createEventWithCategory(objCClass, createEventWithCategory$, new NSString(category), new NSString(action),
			label != null ? new NSString(label) : null, value);
	}
	...
	@Bridge
	private native static GAIDictionaryBuilder objc_createExceptionWithDescription (ObjCClass __self__, Selector __cmd__,
	...
	public static GAIDictionaryBuilder createExceptionWithDescription (String description, boolean fatal) {
		return objc_createExceptionWithDescription(objCClass, createExceptionWithDescription$, new NSString(description),
			NSNumber.valueOf(fatal));
	}
	...
	private static final Selector createItemWithTransactionId$ = Selector
		.register("createItemWithTransactionId:name:sku:category:price:quantity:currencyCode:");

	@Bridge
	private native static GAIDictionaryBuilder objc_createItemWithTransactionId (ObjCClass __self__, Selector __cmd__,
		NSString transactionId, NSString name, NSString sku, NSString category, NSNumber price, NSNumber quantity,
		NSString currencyCode);

	/** Returns a GAIDictionaryBuilder object with parameters specific to an item hit. */
	public static GAIDictionaryBuilder createItemWithTransactionId (NSString transactionId, NSString name, NSString sku,
		NSString category, NSNumber price, NSNumber quantity, NSString currencyCode) {
		return objc_createItemWithTransactionId(objCClass, createItemWithTransactionId$, transactionId, name, sku, category, price,
	...
	@Bridge
	private native static GAIDictionaryBuilder objc_createSocialWithNetwork (ObjCClass __self__, Selector __cmd__,
	...
	@Bridge
	private native static GAIDictionaryBuilder objc_createTimingWithCategory (ObjCClass __self__, Selector __cmd__,
	...
	public static GAIDictionaryBuilder createTimingWithCategory (NSString category, NSNumber intervalMillis, NSString name,
		NSString label) {
	...
	// currencyCode:(NSString *)currencyCode;
	private static final Selector createTransactionWithId$ = Selector
		.register("createTransactionWithId:affiliation:revenue:tax:shipping:currencyCode:");

	@Bridge
	private native static GAIDictionaryBuilder objc_createTransactionWithId (ObjCClass __self__, Selector __cmd__,
	...
	public static GAIDictionaryBuilder createTransactionWithId (NSString transactionId, NSString affiliation, NSNumber revenue,
		NSNumber tax, NSNumber shipping, NSString currencyCode) {
		return objc_createTransactionWithId(objCClass, createTransactionWithId$, transactionId, affiliation, revenue, tax,
