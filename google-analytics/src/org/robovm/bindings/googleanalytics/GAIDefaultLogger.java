...
public class GAIDefaultLogger extends NSObject implements GAILogger {
	...
	@Bridge
	private native static void objc_verbose (GAIDefaultLogger __self__, Selector __cmd__, NSString message);
	...
	@Bridge
	private native static void objc_info (GAIDefaultLogger __self__, Selector __cmd__, NSString message);
	...
	@Bridge
	private native static void objc_warning (GAIDefaultLogger __self__, Selector __cmd__, NSString message);
	...
	@Bridge
	private native static void objc_error (GAIDefaultLogger __self__, Selector __cmd__, NSString message);
