...
public class GAITrackerImpl extends NSObject implements GAITracker {
	...
	@Bridge
	private native static void objc_set (GAITrackerImpl __self__, Selector __cmd__, NSString parameterName, NSString value);
	...
	@Bridge
	private native static String objc_get (GAITrackerImpl __self__, Selector __cmd__, NSString parameterName);
	...
	@Bridge
	private native static void objc_send (GAITrackerImpl __self__, Selector __cmd__, NSDictionary parameters);
