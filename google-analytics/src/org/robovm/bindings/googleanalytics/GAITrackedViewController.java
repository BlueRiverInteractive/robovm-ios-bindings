...
public class GAITrackedViewController extends UIViewController {
	...
	@Bridge
	private native static GAITrackerImpl objc_tracker (GAITrackedViewController __self__, Selector __cmd__);
	...
	@Bridge
	private native static void objc_setTracker (GAITrackedViewController __self__, Selector __cmd__, GAITrackerImpl tracker);
	...
	@Bridge
	private native static NSString objc_screenName (GAITrackedViewController __self__, Selector __cmd__);
	...
	@Bridge
	private native static NSString objc_setScreenName (GAITrackedViewController __self__, Selector __cmd__, NSString screenName);
