...
public class GAI extends NSObject {
	...
	@Bridge
	private native static GAITrackerImpl objc_defaultTracker (GAI __self__, Selector __cmd__);

	/** For convenience, this class exposes a default tracker instance. This is initialized to `nil` and will be set to the first
	 * tracker that is instantiated in trackerWithTrackingId:. It may be overridden as desired.
	 * 
	...
	@Bridge
	private native static GAITrackerImpl objc_setDefaultTracker (GAI __self__, Selector __cmd__, GAITrackerImpl tracker);
	...
	@Bridge
	private native static GAIDefaultLogger objc_logger (GAI __self__, Selector __cmd__);
	...
	@Bridge
	private native static GAIDefaultLogger objc_setLogger (GAI __self__, Selector __cmd__, GAIDefaultLogger logger);
	...
	@Bridge
	private native static boolean objc_optOut (GAI __self__, Selector __cmd__);
	...
	@Bridge
	private native static boolean objc_setOptOut (GAI __self__, Selector __cmd__, boolean optOut);

	public boolean setOptOut (boolean optOut) {
		return objc_setOptOut(this, setOptOut$, optOut);
	}

	/** TODO find out about NSTimeInterval //@property(nonatomic, assign) NSTimeInterval dispatchInterval; private static final
	 * Selector dispatchInterval$ = Selector.register("dispatchInterval");
	 ...
	 * 
	 *         By default, this is set to `120`, which indicates tracking information should be dispatched automatically every 120
	 *         seconds. public NSTimeInterval dispatchInterval(){ return objc_dispatchInterval(this, dispatchInterval$); } */
	...
	@Bridge
	private native static boolean objc_trackUncaughtExceptions (GAI __self__, Selector __cmd__);

	/** When set to true, the SDK will record the currently registered uncaught exception handler, and then register an uncaught
	 * exception handler which tracks the exceptions that occurred using defaultTracker. If defaultTracker is not `nil`, this
	 * function will track the exception on the tracker and attempt to dispatch any outstanding tracking information for 5 seconds.
	 * It will then call the previously registered exception handler, if any. When set back to false, the previously registered
	 * uncaught exception handler will be restored. */
	...
	@Bridge
	private native static boolean objc_setTrackUncaughtExceptions (GAI __self__, Selector __cmd__, boolean track);
	...
	@Bridge
	private native static boolean objc_dryRun (GAI __self__, Selector __cmd__);
	...
	@Bridge
	private native static void objc_setDryRun (GAI __self__, Selector __cmd__, boolean dryRun);
	...
	@Bridge
	private native static GAI objc_sharedInstance (ObjCClass __self__, Selector __cmd__);
	...
	@Bridge
	private native static GAITrackerImpl objc_trackerWithName (GAI __self__, Selector __cmd__, NSString name, NSString trackingId);
	 ...
	 * 
	 * @param trackingID The tracking ID to use for this tracker. It should be of the form `UA-xxxxx-y`.
	 * 
	...
	@Bridge
	private native static GAITrackerImpl objc_trackerWithTrackingId (GAI __self__, Selector __cmd__, NSString trackingId);
	 ...
	 * 
	 * @param trackingID The tracking ID to use for this tracker. It should be of the form `UA-xxxxx-y`. The name of the tracker
	...
	@Bridge
	private native static void objc_removeTrackerByName (GAI __self__, Selector __cmd__, NSString name);
	...
	@Bridge
	private native static void objc_dispatch (GAI __self__, Selector __cmd__);
