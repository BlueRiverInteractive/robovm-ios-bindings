...
public interface SKRequestDelegate extends NSObjectProtocol {
	...
	public static class Adapter extends NSObject implements SKRequestDelegate {
		// @NotImplemented("accelerometer:didAccelerate:") public void didAccelerate(UIAccelerometer accelerometer, UIAcceleration acceleration) {
	...
	static class Callbacks {
		// @Callback @BindSelector("accelerometer:didAccelerate:") public static void didAccelerate(UIAccelerometerDelegate __self__, Selector
		// __cmd__, UIAccelerometer accelerometer, UIAcceleration acceleration) { __self__.didAccelerate(accelerometer, acceleration); }
		@Callback
