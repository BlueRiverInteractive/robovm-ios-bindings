...
public class InAppPurchaseManager extends SKProductsRequestDelegate.Adapter {
	 ...
	 * 
	 * @param listener
	 *            The listener interface for common callbacks.
	 */
	...
	/**
	 * Request the product information for the specified product identifiers. Calls {@link InAppPurchaseListener#productsReceived(SKProduct[])} on
	 * success or {@link InAppPurchaseListener#productsRequestFailed(SKRequest, NSError)} on fail.
	 * 
	 * @param productIds
	 *            The identifiers of the products you want to query.
	 */
	 ...
	 * 
	 * @param productIds
	 *            The identifiers of the products you want to query as a java List.
	 */
	...
	void transactionFailed(SKPaymentTransaction transaction) {
		System.out.println(TAG + " Transaction '" + transaction.getTransactionIdentifier() + "' failed! Error: " + transaction.getError().toString());
		SKPaymentQueue.getDefaultQueue().finishTransaction(transaction);
