 ...
 * </p>
 * <p>
 * This class provides methods necessary for correct function of FlurryAds.h. For information on how to use Flurry's Ads SDK to attract high-quality
 * users and monetize your user base see <a href="http://support.flurry.com/index.php?title=Publishers">Support Center - Publishers</a>.
 * </p>
 * 
 * @version SDK 4.2.3
 */
...
public class Flurry extends NSObject {
	 ...
	 * {@code didFinishLaunching} delegate method. The session will continue for the period the app is in the foreground until your app is
	 * backgrounded for the time specified in {@link #setSessionContinueSeconds(int)}. If the app is resumed in that period the session will continue,
	 * otherwise a new session will begin.
	 * </p>
	 * 
	 * <p>
	 ...
	 * 
	 * <p>
	 * If testing on a simulator, please be sure to send App to background via home button. Flurry depends on the iOS lifecycle to be complete for
	 * full reporting.
	 * </p>
	 * 
	 ...
	 * <p>
	 * This method serves as the entry point to Flurry Analytics collection. It must be called in the scope of the Application's
	 * {@code didFinishLaunching} delegate method. passing in the launchOptions param. The session will continue for the period the app is in the
	 * foreground until your app is backgrounded for the time specified in {@link #setSessionContinueSeconds(int)}. If the app is resumed in that
	 * period the session will continue, otherwise a new session will begin.
	 * </p>
	 * 
	 * <p>
	 * If testing on a simulator, please be sure to send App to background via home button. Flurry depends on the iOS lifecycle to be complete for
	 ...
	 *            The API key for this project.
	 * @param launchOptions
	 *            passed launchOptions from the application's didFinishLaunching delegate method.
	 */
	public static void startSession(String apiKey, NSDictionary<?, ?> launchOptions) {
		objc_startSessionWithOptions(objCClass, startSessionWithOptions, new NSString(apiKey), launchOptions);
	}
	 ...
	 * 
	 * <p>
	 * This method is useful in case of {@link #setBackgroundSessionEnabled(boolean)} set to {@code true}. It can be called when application finished
	 * all background tasks (such as playing music) to pause session. If the app is resumed before time specified in
	 * {@link #setSessionContinueSeconds(int)}, the session will continue, otherwise a new session will begin.
	 * </p>
	 * 
	 * @see #setSessionContinueSeconds(int)
	 ...
	 * 
	 * <p>
	 * This method allows you to specify custom events within your app. As a general rule you should capture events related to user navigation within
	 * your app, any action around monetization, and other events as they are applicable to tracking progress towards your business goals.
	 * </p>
	 * 
	 * <p>
	 * You should not pass private or confidential information about your users in a custom event. <br/>
	 * Where applicable, you should make a concerted effort to use timed events with parameters ({@link #logEvent(String, NSDictionary, boolean)}) or
	 * events with parameters ({@link #logEvent(String, NSDictionary)}). This provides valuable information around the time the user spends within an
	 * action (e.g. - time spent on a level or viewing a page) or characteristics of an action (e.g. - Buy Event that has a Parameter of Widget with
	 * Value Golden Sword).
	 * </p>
	 * 
	 ...
	 * @since 2.8.4
	 * @param eventName
	 *            Name of the event. For maximum effectiveness, we recommend using a naming scheme that can be easily understood by non-technical
	 *            people in your business domain.
	 */
	 ...
	 * 
	 * <p>
	 * This method overrides {@link #logEvent(String)} to allow you to associate parameters with an event. Parameters are extremely valuable as they
	 * allow you to store characteristics of an action. For example, if a user purchased an item it may be helpful to know what level that user was
	 * on. By setting this parameter you will be able to view a distribution of levels for the purchased event on the <a
	 * href="http://dev.flurry.com">Flurrly Dev Portal</a>.
	 * </p>
	 * 
	 * <p>
	 * You should not pass private or confidential information about your users in a custom event. <br/>
	 * A maximum of 10 parameter names may be associated with any event. Sending over 10 parameter names with a single event will result in no
	 * parameters being logged for that event. You may specify an infinite number of Parameter values. For example, a Search Box would have 1
	 * parameter name (e.g. - Search Box) and many values, which would allow you to see what values users look for the most in your app. <br/>
	 * Where applicable, you should make a concerted effort to use timed events with parameters ({@link #logEvent(String, NSDictionary, boolean)}).
	 * This provides valuable information around the time the user spends within an action (e.g. - time spent on a level or viewing a page).
	 * </p>
	 * 
	 * @see #logEvent(String, NSDictionary, boolean)
	 * @since 2.8.4
	 ...
	 *            people in your business domain.
	 * @param parameters
	 *            A map containing Name-Value pairs of parameters.
	 */
	 ...
	 * 
	 * <p>
	 * This method captures an exception for reporting to Flurry. We recommend adding an uncaught exception listener to capture any exceptions that
	 * occur during usage that is not anticipated by your app.
	 * </p>
	 * 
	 ...
	 * 
	 * <p>
	 * This method overrides {@link #logEvent(String)} to allow you to capture the length of an event. This can be extremely valuable to understand
	 * the level of engagement with a particular action. For example, you can capture how long a user spends on a level or reading an article.
	 * </p>
	 * 
	 * <p>
	 * You should not pass private or confidential information about your users in a custom event. <br/>
	 * Where applicable, you should make a concerted effort to use parameters with your timed events ({@link #logEvent(String, NSDictionary, boolean)}
	 * ). This provides valuable information around the characteristics of an action (e.g. - Buy Event that has a Parameter of Widget with Value
	 * Golden Sword).
	 * </p>
	 * 
	 * @see #logEvent(String, NSDictionary, boolean)
	 ...
	 *            people in your business domain.
	 * @param timed
	 *            Specifies the event will be timed.
	 */
	 ...
	 * 
	 * <p>
	 * This method overrides {@link #logEvent(String)} to allow you to capture the length of an event with parameters. This can be extremely valuable
	 * to understand the level of engagement with a particular action and the characteristics associated with that action. For example, you can
	 * capture how long a user spends on a level or reading an article. Parameters can be used to capture, for example, the author of an article or if
	 * something was purchased while on the level.
	 * </p>
	 * 
	 * <p>
	...
	public static void logEvent(String eventName, NSDictionary<?, ?> parameters, boolean timed) {
		objc_logEventWithParametersTimed(objCClass, logEventWithParametersTimed, new NSString(eventName), parameters, timed);
	}
	 ...
	 * 
	 * <p>
	 * This method ends an existing timed event. If parameters are provided, this will overwrite existing parameters with the same name or create new
	 * parameters if the name does not exist in the parameter map set by {@link #logEvent(String, NSDictionary, boolean)}.
	 * </p>
	 * 
	 * <p>
	 * You should not pass private or confidential information about your users in a custom event. <br/>
	...
	public static void endTimedEvent(String eventName, NSDictionary<?, ?> parameters) {
		objc_endTimedEventParameters(objCClass, endTimedEventParameters, new NSString(eventName), parameters);
	}
	 ...
	 * 
	 * <p>
	 * This is an optional method that overrides the App Version Flurry uses for reporting. Flurry will use the CFBundleVersion in your info.plist
	 * file when this method is not invoked.
	 * </p>
	 * 
	 * <p>
	 ...
	 * 
	 * <p>
	 * This is an optional method that retrieves the Flurry Agent Version the app is running under. It is most often used if reporting an unexpected
	 * behavior of the SDK to <a href="mailto:iphonesupport@flurry.com"> Flurry Support</a>
	 * </p>
	 * 
	 * <p>
	 * This method must be called prior to invoking {@link #startSession(String)}. <br/>
	 * FAQ for the iPhone SDK is located at <a href="http://wiki.flurry.com/index.php?title=IPhone_FAQ"> Support Center - iPhone FAQ</a>.
	 * </p>
	 * 
	 * @see #setLogLevel
	 * @since 2.7
	 ...
	 * 
	 * <p>
	 * This is an optional method that augments the debug logs with exceptions that occur during the session. You must both capture exceptions to
	 * Flurry and set debug logging to enabled for this method to display information to the console. The default setting for this method is
	 * {@code false}.
	 * </p>
	 * 
	 * <p>
	 ...
	 * @since 2.7
	 * @param enabled
	 *            {@code true} to show errors in debug logs, {@code false} to omit errors in debug logs.
	 */
	 ...
	 * 
	 * <p>
	 * This is an optional method that displays debug information related to the Flurry SDK. display information to the console. The default setting
	 * for this method is {@code false} which sets the log level to {@code CriticalOnly}. When set to {@code true} the debug log level is set to
	 * {@code Debug}
	 * </p>
	 * 
	 * <p>
	 * This method must be called prior to invoking {@link #startSession(String)}. If the method, {@link #setLogLevel(FlurryLogLevel)} is called later
	 * in the code, debug logging will be automatically enabled.
	 * </p>
	 * 
	 * @since 2.7
	 * 
	 * @param enabled
	 *            {@code true} to show debug logs, {@code false} to omit debug logs.
	 */
	 ...
	 * <p>
	 * This is an optional method that displays debug information related to the Flurry SDK. display information to the console. The default setting
	 * for this method is {@code CriticalOnly}.
	 * </p>
	 * 
	 * <p>
	 * Its good practice to call this method prior to invoking {@link #startSession(String)}. If debug logging is disabled earlier, this method will
	 * enable it.
	 * </p>
	 * 
	 * @since 4.2.2
	 ...
	 * 
	 * <p>
	 * This is an optional method that sets the time the app may be in the background before starting a new session upon resume. The default value for
	 * the session timeout is 10 seconds in the background.
	 * </p>
	 * 
	 * <p>
	 * This method must be called prior to invoking {@link #startSession(String)}.
	 ...
	 * 
	 * @param enabled
	 *            {@code true} to send data over secure connection.
	 */
	 ...
	 * 
	 * @param enabled
	 *            {@code true} to enable collection of crash reports.
	 */
	 ...
	 * 
	 * <p>
	 * This method increments the page view count for a session based on traversing a UINavigationController or UITabBarController. The page view
	 * count is only a counter for the number of transitions in your app. It does not associate a name with the page count. To associate a name with a
	 * count of occurences see {@link #logEvent(String)}.
	 * </p>
	 * 
	 * <p>
	 ...
	 * 
	 * @param target
	 *            The navigation or tab bar controller.
	 */
	 ...
	 * 
	 * <p>
	 * This method increments the page view count for a session when invoked. It does not associate a name with the page count. To associate a name
	 * with a count of occurrences see {@link #logEvent(String)}.
	 * </p>
	 * 
	 * @see #logAllPageViews(NSObject) for details on automatically incrementing page view count based on user traversing navigation or tab bar
	 *      controller.
	 * @since 2.7
	 */
	 ...
	 * 
	 * <p>
	 * Use this method to capture the age of your user. Only use this method if you collect this information explicitly from your user (i.e. - there
	 * is no need to set a default value).
	 * </p>
	 * 
	 * <p>
	 ...
	 * 
	 * <p>
	 * Use this method to capture the gender of your user. Only use this method if you collect this information explicitly from your user (i.e. -
	 * there is no need to set a default value). Allowable values are {@code "m"} or {@code "f"}.
	 * </p>
	 * 
	 * <p>
	 ...
	 * 
	 * <p>
	 * Use information from the CLLocationManager to specify the location of the session. Flurry does not automatically track this information or
	 * include the {@code CLLocation} framework.
	 * </p>
	 * 
	 * <p>
	 ...
	 * 
	 * <p>
	 * After starting the location manager, you can set the location with Flurry. You can implement {@code CLLocationManagerDelegate} to be aware of
	 * when the location is updated. Below is an example of how to use this method, after you have received a location update from the
	 * locationManager.
	 * </p>
	 * 
	 * @since 2.7
	 ...
	 * 
	 * @param enabled
	 *            {@code true} to send on close, {@code false} to omit reporting on close.
	 */
	 ...
	 * 
	 * @param enabled
	 *            {@code true} to send on pause, {@code false} to omit reporting on pause.
	 */
	 ...
	 * 
	 * <p>
	 * Use this method finish session data when the app is paused. The default value is taken looking at the UIBackgroundModes of application's
	 * Info.plist. If UIBackgroundModes array is empty, equals {@code false}, otherwise {@code true}.
	 * </p>
	 * 
	 * @since 4.2.2
	 * 
	 * @param enabled
	 *            {@code false} to finish on resigning active, {@code true} to omit finishing.</p>
	 */
	 ...
	 * 
	 * @param enabled
	 *            {@code true} to enable event logging, {@code false} to stop custom logging.
	 */
	...
	// SELECTORS
	// ================
	private static final Selector startSessionWithOptions = Selector.register("startSession:withOptions:");
	private static final Selector pauseBackgroundSession = Selector.register("pauseBackgroundSession");
	private static final Selector logEventWithParametersTimed = Selector.register("logEvent:withParameters:timed:");
	...
	private static final Selector endTimedEventParameters = Selector.register("endTimedEvent:withParameters:");
	...
	// ================
	@Bridge
	private native static void objc_startSessionWithOptions(ObjCClass __self__, Selector __cmd__, NSString apiKey, NSDictionary<?, ?> options);
	...
	// @Bridge
	// private native static void objc_logException(ObjCClass __self__, Selector __cmd__, NSString errorId, NSString message, NSException exception);

	@Bridge
	private native static void objc_logError(ObjCClass __self__, Selector __cmd__, NSString errorId, NSString message, NSError error);

	@Bridge
	private native static void objc_endTimedEventParameters(ObjCClass __self__, Selector __cmd__, NSString eventName, NSDictionary<?, ?> parameters);
	...
	@Bridge
	private native static void objc_setLocation(ObjCClass __self__, Selector __cmd__, double latitude, double longitude, float horizontalAccuracy,
