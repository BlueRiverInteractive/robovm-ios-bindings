...
public class Flurry extends NSObject {
     ...
     * 
     * <p>
     * This method captures an exception for reporting to Flurry. We recommend adding an uncaught exception listener to capture
     * any exceptions that occur during usage that is not anticipated by your app.
     * </p>
     * 
     ...
     * 
     * <p>
     * This method allows you to specify custom events within your app. As a general rule you should capture events related to
     * user navigation within your app, any action around monetization, and other events as they are applicable to tracking
     ...
     * 
     * <p>
     * This method overrides {@link #logEvent(String)} to allow you to associate parameters with an event. Parameters are
     * extremely valuable as they allow you to store characteristics of an action. For example, if a user purchased an item it may
     * be helpful to know what level that user was on. By setting this parameter you will be able to view a distribution of levels
     * for the purchased event on the <a href="http://dev.flurry.com">Flurrly Dev Portal</a>.
     * </p>
     * 
     * <p>
     * You should not pass private or confidential information about your users in a custom event. <br/>
     ...
     * Where applicable, you should make a concerted effort to use timed events with parameters (
     * {@link #logEvent(String, NSDictionary, boolean)}). This provides valuable information around the time the user spends
     * within an action (e.g. - time spent on a level or viewing a page).
     * </p>
     * 
     * @see #logEvent(String, NSDictionary, boolean)
     * @since 2.8.4
     ...
     * valuable to understand the level of engagement with a particular action. For example, you can capture how long a user
     * spends on a level or reading an article.
     * </p>
     * 
     * <p>
     * You should not pass private or confidential information about your users in a custom event. <br/>
     ...
     * that action. For example, you can capture how long a user spends on a level or reading an article. Parameters can be used
     * to capture, for example, the author of an article or if something was purchased while on the level.
     * </p>
     * 
     * <p>
     ...
     * 
     * <p>
     * This is an optional method that augments the debug logs with exceptions that occur during the session. You must both
     * capture exceptions to Flurry and set debug logging to enabled for this method to display information to the console. The
     * default setting for this method is {@code false}.
     * </p>
     * 
     * <p>
     * This method must be called prior to invoking {@link #startSession(String)}.
     ...
     * 
     * <p>
     * Its good practice to call this method prior to invoking {@link #startSession(String)}. If debug logging is disabled
     * earlier, this method will enable it.
     * </p>
     * 
     * @since 4.2.2
     * 
     ...
     * {@code CLLocationManagerDelegate} to be aware of when the location is updated. Below is an example of how to use this
     * method, after you have received a location update from the locationManager.
     * </p>
     * 
     * @since 2.7
     * 
