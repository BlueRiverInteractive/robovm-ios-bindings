...
public interface CLLocationManagerDelegate extends NSObjectProtocol {
	...
	public static class Adapter extends NSObject implements CLLocationManagerDelegate {
		...
		@Override
		public CLLocationManagerDelegate didUpdateToLocation (CLLocationManager manager, CLLocation newLocation,
	...
	static class Callbacks {
		...
		public static CLLocationManagerDelegate objc_didUpdateLocations (CLLocationManagerDelegate __self__, Selector __cmd__,
		...
		public static CLLocationManagerDelegate objc_didFailWithError (CLLocationManagerDelegate __self__, Selector __cmd__,
		...
		public static CLLocationManagerDelegate objc_didUpdateToLocation (CLLocationManagerDelegate __self__, Selector __cmd__,
			CLLocationManager manager, CLLocation newLocation, CLLocation oldLocation) {
